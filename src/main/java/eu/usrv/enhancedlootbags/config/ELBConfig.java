...
public class ELBConfig extends ConfigManager
{
	...
	protected void Init()
	{
		AllowFortuneBags = _mainConfig.getBoolean( "AllowFortuneBags", "Generic", AllowFortuneBags, "Set to true to disable the TrashGroup merging if FortuneIII is applied to a lootbag" );
	}
