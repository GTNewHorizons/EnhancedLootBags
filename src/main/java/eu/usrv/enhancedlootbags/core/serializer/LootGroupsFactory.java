...
public class LootGroupsFactory {
     ...
     * @param pTrashCombine
     * Defaults to true. If set to false, this group is not combined with group 0 and will only drop items from this
     * group
     * @return
     */
    public LootGroup createLootGroup(
            int pGroupID, String pGroupName, EnumRarity pRarity, int pMinItems, int pMaxItems, boolean pTrashCombine) {
     ...
     *
     * @param pItemName
     * The Minecraft-Notation of the item you want to add. Use modID:itemname:metaID The MetaID can be omitted if it is
     * :0
     * @param pIdentifier
     ...
     * The optional ItemGroup name. If set to something else than an empty string. this item will always drop TOGETHER
     * with all items that have the same GroupID. Note: This bypasses the maxItem amount
     * @return
     */
    public Drop createDrop(
            String pItemName,
